...
// PVS-Studio Static Code Analyzer for C, C++, C#, and Java: https://pvs-studio.com
 ...
 int strategiaColumn::chooseBranchingIndex(BoolInterval** cnf, int cnfSize, BBV& mask) const {
 ...
 int strategiaRow::chooseBranchingIndex(BoolInterval** cnf, int cnfSize, BBV& mask) const {
     ...
     return strategiaColumn().chooseBranchingIndex(cnf, cnfSize, mask);
 }